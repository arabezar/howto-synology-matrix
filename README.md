...
Выполните команду загрузки и выполнения скрипта развёртывания:
```bash
...
```
Отвечайте на вопросы, следите за исполнением скрипта. После выполнения переходите к [Запуску проекта](#запуск-проекта)

### Развёртывание вручную
#### Подготовка папок и ключей
Выполните команды для создания структуры папок и генерации ключа сервера:
```bash
